    ...
    <div class="content-container">
        ...
        <table>
            ...
            <tr>
                ...
                <th @click="sortDamageReports('RSVP.rentalId')">Rental <i class="fas fa-sort"></i></th>
                <th @click="sortDamageReports('RSVP.receiver')">Receiver <i class="fas fa-sort"></i></th>
                <th @click="sortDamageReports('RSVP.issuedDate')">Date Rented <i class="fas fa-sort"></i></th>
            ...
            <tr v-for="damageReport in filteredDamageReports" :key="damageReport.id">
                ...
                <td v-if="!damageReport.editing">{{ damageReport.RSVP.rentalId  }}</td>
                <td v-else>
                    <input type="text" v-model="damageReport.RSVP.rentalId " >
                </td>
                <td v-if="!damageReport.editing">{{ damageReport.RSVP.receiver  }}</td>
                <td v-else>
                    <input type="text" v-model="damageReport.RSVP.receiver " >
                </td>
                <td v-if="!damageReport.editing">{{ damageReport.RSVP.issuedDate  }}</td>
                <td v-else>
                    <input type="text" v-model="damageReport.RSVP.issuedDate " >
                </td>
        ...
        >
            <template v-if="damageReportToDelete">
                <div>
                    ...
                    <p>Rental ID: {{ damageReportToDelete.RSVP ? damageReportToDelete.RSVP.id : '' }}</p>
