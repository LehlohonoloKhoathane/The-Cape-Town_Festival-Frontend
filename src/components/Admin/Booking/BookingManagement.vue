    ...
    <table>
      <thead>
        <tr>
          ...
          <th @click="sortBookings('event.name')">Event Name <i class="fas fa-sort"></i></th>
          <th @click="sortBookings('event.model')">Event Details <i class="fas fa-sort"></i></th>
          <th @click="sortBookings('dateBooked')">Date Booked </th>
          <th @click="sortBookings('dateReturned')">Date of Event </th>
...
<td v-else>
  <input type="text" v-model="booking.user.firstName">
          ...
          <td v-if="!booking.editing">{{ booking.event.name }}</td>
          <td v-else>
            <input type="text" v-model="booking.event.name">
          </td>
          <td v-if="!booking.editing">{{ booking.event.model }}</td>
          <td v-else>
            <input type="text" v-model="booking.event.model">
          </td>
    ...
    >
      <template v-if="bookingToDelete">
        <div>
          ...
          <p>Event: {{ bookingToDelete.event.model }}</p>
          <hr>
