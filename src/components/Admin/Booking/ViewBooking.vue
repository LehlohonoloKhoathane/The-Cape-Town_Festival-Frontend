  ...
  <div class="card-container">
    <div class="form-container">
      <div class="booking-profile">
        ...
        <!-- Check if booking, user, and event data is available -->
        <div class="profile-details" v-if="booking && user && event">
          <!-- Booking Details -->
          <div class="section">
...
export default {
  ...
  methods: {
    ...
    fetcheventProfile() {
      const eventId = this.booking.event.id;

      axios
        .get(`http://localhost:8080/api/admin/events/read/${eventId}`)
        .then((response) => {
